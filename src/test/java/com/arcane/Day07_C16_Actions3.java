 ...
 */
    ...
    public void keysUpDown(){
        ...
        //4- cift tiklayarak search box'i etkilestir
        actions.keyDown(searchBox,Keys.SHIFT).//shift buttonuna bas
                sendKeys("iPhone Pro Max").//elementi icine yaz
                keyUp(searchBox,Keys.SHIFT).//shift butonuna basmayi birak
                sendKeys("14 cok pahali"+Keys.ENTER).
                build().//build() opsiyoneldir, perform() daha guclu yapar, build() olmada+nda calisir
                perform();
