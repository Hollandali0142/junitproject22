...
public class Day04_C9_DropDown {
    ...
    public void selectByIndexTest(){
        //1. adim dropdown elementlerine locate et

        WebElement droDown=driver.findElement(By.id("dropdown"));

        //2. adim Select object olustur

        Select select=new Select(droDown);

        //3.adim methoddan herhangi birini kullanarak element bulun==>selectByIndex,selectByValue,selectByVisibleText
    ...
    public void printFirstSelectedOptionTest(){
            ...
            WebElement ilksecileSecenek=select.getFirstSelectedOption();
            System.out.println(ilksecileSecenek.getText());

            // Secili option'in "Please select an option" oldugunu verify et

            Assert.assertEquals("Please select an option",ilksecileSecenek.getText());
