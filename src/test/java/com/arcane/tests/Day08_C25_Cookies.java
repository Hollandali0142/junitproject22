...
//            1. Toplam cookies sayisini bul
            Set<Cookie> tumCoockies=driver.manage().getCookies();
            System.out.println(tumCoockies);
            int cookieSayisi=tumCoockies.size();
            System.out.println(cookieSayisi);

//            2. Tum cookies yazdir
            for(Cookie herbirEleman : tumCoockies){
...
//            4. Yeni cookie ekle
            ...
            //tum cookieleri al ve sayisini yazdir
            tumCoockies=driver.manage().getCookies();
            System.out.println(tumCoockies.size());
